...
type Permissions struct {
	...
	Context   string    `xorm:"CHAR(11) default '00000000000'"` //LogPer,InOrderPer,OutOrderPer,PermissionPer,WarePer
	// ,ProductPer,DestroyPer,QualityPer,CarryPer,InWarePer,SalePer
}
